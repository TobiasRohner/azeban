...
NetCDFStructureFunctionCubeWriter<Dim, SF>::NetCDFStructureFunctionCubeWriter(
    ...
    : super(ncid, grid, snapshot_times, sample_idx_start), func_(func), max_h_(max_h) {
  // Define own group
...
template class NetCDFStructureFunctionCubeWriter<1, SFAbsoluteLongitudinalFunctional>;
template class NetCDFStructureFunctionCubeWriter<2, SFAbsoluteLongitudinalFunctional>;
template class NetCDFStructureFunctionCubeWriter<3, SFAbsoluteLongitudinalFunctional>;
