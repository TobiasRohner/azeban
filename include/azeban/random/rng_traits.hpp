...
struct RNGTraits {
  static_assert(!std::is_same<RNG, RNG>::value, "Unsupported Random Number Generator");
};
...
struct RNGTraits<std::mersenne_twister_engine<UIntType, w, n, m, r, a, u, d, s, b, t, c, l, f>> {
  static constexpr zisa::device_type location = zisa::device_type::cpu;
  using state_t = std::mersenne_twister_engine<UIntType, w, n, m, r, a, u, d, s, b, t, c, l, f>;
};
