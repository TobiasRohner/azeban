...
template <typename T>
void copy_to_padded(const zisa::array_view<T, 1> &dst,
...
template <typename T>
void copy_to_padded(const zisa::array_view<T, 2> &dst,
...
template <typename T>
void copy_to_padded(const zisa::array_view<T, 3> &dst,
...
template <typename T>
void copy_from_padded(const zisa::array_view<T, 1> &dst,
                      const zisa::array_const_view<T, 1> &src) {
  if (src.memory_location() == zisa::device_type::cpu
      && dst.memory_location() == zisa::device_type::cpu) {
    // TODO: Implement
...
template <typename T>
void copy_from_padded(const zisa::array_view<T, 2> &dst,
                      const zisa::array_const_view<T, 2> &src) {
  if (src.memory_location() == zisa::device_type::cpu
      && dst.memory_location() == zisa::device_type::cpu) {
    // TODO: Implement
...
template <typename T>
void copy_from_padded(const zisa::array_view<T, 3> &dst,
                      const zisa::array_const_view<T, 3> &src) {
  if (src.memory_location() == zisa::device_type::cpu
      && dst.memory_location() == zisa::device_type::cpu) {
    // TODO: Implement
