...
#include <azeban/forcing/white_noise_high_freq.hpp>
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    Step1D, WhiteNoiseHighFreq<2 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    Step1D, WhiteNoiseHighFreq<2 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    Step1D, WhiteNoiseHighFreq<2 COMMA std::mt19937>)
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    SmoothCutoff1D, WhiteNoiseHighFreq<2 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    SmoothCutoff1D, WhiteNoiseHighFreq<2 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    SmoothCutoff1D, WhiteNoiseHighFreq<2 COMMA std::mt19937>)
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    Quadratic, WhiteNoiseHighFreq<2 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    Quadratic, WhiteNoiseHighFreq<2 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    Quadratic, WhiteNoiseHighFreq<2 COMMA std::mt19937>)
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    NoViscosity, WhiteNoiseHighFreq<2 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    NoViscosity, WhiteNoiseHighFreq<2 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_2D(
    NoViscosity, WhiteNoiseHighFreq<2 COMMA std::mt19937>)
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    Step1D, WhiteNoiseHighFreq<3 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    Step1D, WhiteNoiseHighFreq<3 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    Step1D, WhiteNoiseHighFreq<3 COMMA std::mt19937>)
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    SmoothCutoff1D, WhiteNoiseHighFreq<3 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    SmoothCutoff1D, WhiteNoiseHighFreq<3 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    SmoothCutoff1D, WhiteNoiseHighFreq<3 COMMA std::mt19937>)
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    Quadratic, WhiteNoiseHighFreq<3 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    Quadratic, WhiteNoiseHighFreq<3 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    Quadratic, WhiteNoiseHighFreq<3 COMMA std::mt19937>)
...
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    NoViscosity, WhiteNoiseHighFreq<3 COMMA curandStateMRG32k3a_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    NoViscosity, WhiteNoiseHighFreq<3 COMMA curandStateXORWOW_t>)
AZEBAN_INSTANTIATE_INCOMPRESSIBLE_EULER_CUDA_3D(
    NoViscosity, WhiteNoiseHighFreq<3 COMMA std::mt19937>)
