#ifndef AZEBAN_NETCDF_ENSTROPHY_SPECTRUM_WRITER_HPP_
#define AZEBAN_NETCDF_ENSTROPHY_SPECTRUM_WRITER_HPP_
...
template <int Dim>
class NetCDFEnstrophySpectrumWriter : public NetCDFWriter<Dim> {
