...
class SFAbsoluteLongitudinalFunctional {
public:
  ANY_DEVICE_INLINE SFAbsoluteLongitudinalFunctional(real_t p) : p_(p) {}
  ANY_DEVICE_INLINE
  SFAbsoluteLongitudinalFunctional(const SFAbsoluteLongitudinalFunctional &)
      = default;
  ANY_DEVICE_INLINE SFAbsoluteLongitudinalFunctional &
  operator=(const SFAbsoluteLongitudinalFunctional &)
      = default;
